      ...
      <div className="text-content">
        ...
        <div className="contact-box">
          <div className="contact-item">
            <i className="far fa-envelope contact-icon"></i> <a class="contact-link"
            href="mailto:emilyrandall1998@gmail.com">emilyrandall1998@gmail.com</a>
          </div>
          <div className="contact-item">
            <i className="fab fa-linkedin contact-icon"></i> <a class="contact-link" target='_blank' 
            href="www.linkedin.com/in/emilyjanerandall">www.linkedin.com/in/emilyjanerandall</a>
          </div>
          <div className="contact-item">
            <i className="fab fa-github-square contact-icon"></i> <a class="contact-link" target='_blank' 

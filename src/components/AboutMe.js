  ...
  return <section className="hero is-large" id="aboutme">
    <div className="hero-body">
      <div className="aboutme">
        ...
        <p>I decided the best way to begin this career change was through an intensive course, so I undertook the SEI course at GA during lockdown to give me a strong foundation and solidify what has now become a passion for coding. I am looking to work in a dynamic and collaborative environment, where I can share my creative ideas but also continue to learn from and develop my skill set.</p>
      </div>
    </div>
  </section>

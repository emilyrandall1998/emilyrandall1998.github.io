  ...
  return <section className="hero is-large" id="projects">
    <div className="hero-body">
      <div className="text-content">
        ...
        <p style={{'width': '50vw'}}>Check out the deployed website under the description, or for the GitHub repo click <u><a href="https://github.com/emilyrandall1998" target="blank">here</a></u>!</p><br />
        <div className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back">
              ...
              <a href="https://picster-project-4.herokuapp.com/" target="blank"><i className="devicon-heroku-original" id="p4"></i></a>
            </div>
          </div>
        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back">
              ...
              <a href="https://hack-a-snack.herokuapp.com/" target="blank"><i className="devicon-heroku-original" id="p3"></i></a>
            </div>
          </div>
        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back">
              ...
              <a href="https://nalderson.github.io/project-2/" target="blank"><i className="devicon-github-original-wordmark" id="p2"></i></a>
            </div>
          </div>
        ...
        <div className="flip-card">
          <div className="flip-card-inner">
            ...
            <div className="flip-card-back">
              ...
              <a href="https://emilyrandall1998.github.io/project-one/" target="blank"><i className="devicon-github-original-wordmark" id="p1"></i></a>
            </div>
          </div>
